...
namespace BEPUphysics.Paths
{
    ...
    public class VariableAngularSpeedCurve : VariableSpeedCurve<Quaternion>
    {
        ...
        public VariableAngularSpeedCurve(Path<FP> speedCurve, Curve<Quaternion> curve)
        ...
        public VariableAngularSpeedCurve(Path<FP> speedCurve, Curve<Quaternion> curve, int sampleCount)
            : base(speedCurve, curve, sampleCount)
        {
        }

        protected override FP GetDistance(Quaternion start, Quaternion end)
        {
