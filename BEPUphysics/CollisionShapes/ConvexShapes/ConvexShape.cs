...
namespace BEPUphysics.CollisionShapes.ConvexShapes
{
    ...
    public abstract class ConvexShape : EntityShape
    {
        ...
        public void GetExtremePoint(Vector3 direction, ref RigidTransform shapeTransform, out Vector3 extremePoint)
        {
            ...
            {
                Vector3.Multiply(ref direction, collisionMargin / FP.Sqrt(directionLength), out direction);
        ...
        public virtual bool RayTest(ref Ray ray, ref RigidTransform transform, FP maximumLength, out RayHit hit)
        {
