...
namespace BEPUphysics.CollisionShapes
{
    ...
    public class MobileMeshShape : EntityShape
    {
        ...
        private void GetBoundingBox(ref Matrix3x3 o, out BoundingBox boundingBox)
        {
            ...
            Vector3.Multiply(ref rightDirection, meshCollisionMargin / FP.Sqrt(rightDirection.Length()), out rightDirection);
            Vector3.Multiply(ref upDirection, meshCollisionMargin / FP.Sqrt(upDirection.Length()), out upDirection);
            Vector3.Multiply(ref backDirection, meshCollisionMargin / FP.Sqrt(backDirection.Length()), out backDirection);
