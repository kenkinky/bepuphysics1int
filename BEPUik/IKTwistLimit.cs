...
namespace BEPUik
{
    ...
    public class IKTwistLimit : IKLimit
    {
        ...
        public void ComputeMeasurementAxes()
        {
            ...
            {
                Vector3.Divide(ref worldMeasurementAxisA, FP.Sqrt(lengthSquared), out worldMeasurementAxisA);
            }
            else
            {
        ...
        public IKTwistLimit(Bone connectionA, Bone connectionB, Vector3 axisA, Vector3 axisB, FP maximumAngle)
        ...
        protected internal override void UpdateJacobiansAndVelocityBias()
        {
            ...
            if (lengthSquared > Toolbox.Epsilon)
            {
                Vector3.Divide(ref jacobian, FP.Sqrt(lengthSquared), out jacobian);
            }
            else
            {
