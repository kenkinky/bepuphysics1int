...
namespace BEPUphysics.Character
{
    ...
    public class HorizontalMotionConstraint : SolverUpdateable
    {
        ...
        public Vector2 MovementDirection
        {
            ...
            set
            {
                if (movementDirection.X != value.X || movementDirection.Y != value.Y) //Fix64ing point comparison is perfectly fine here. Any bitwise variation should go through.
                {
                    ...
                    {
                        Vector2.Divide(ref value, FP.Sqrt(lengthSquared), out movementDirection);
                    }
                    else
                    {
        ...
        public void UpdateMovementBasis(ref Vector3 forward)
        {
            ...
            {
                Vector3.Divide(ref horizontalForwardDirection, FP.Sqrt(forwardLengthSquared), out horizontalForwardDirection);
        ...
        public override void Update(FP dt)
        {
            ...
            if (MovementMode != MovementMode.Floating)
            {
                ...
                else
                {
                    ...
                    Vector3.Divide(ref linearJacobianA1, FP.Sqrt(length), out linearJacobianA1);
        ...
        public override FP SolveIteration()
        {
            ...
            else
            {
                ...
                {
                    Vector2.Multiply(ref accumulatedImpulse, maxForceDt / FP.Sqrt(length), out accumulatedImpulse);
                }
