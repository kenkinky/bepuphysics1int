...
namespace BEPUphysics.CollisionShapes.ConvexShapes
{
    ...
    public class ConvexHullShape : ConvexShape
    {
        ...
        public static ConvexShapeDescription ComputeDescription(IList<Vector3> vertices, FP collisionMargin, out Vector3 center, IList<int> outputHullTriangleIndices, IList<Vector3> outputUniqueSurfaceVertices)
        {
        ...
        public static FP ComputeMaximumRadius(IList<Vector3> localSurfaceVertices, FP collisionMargin)
        {
