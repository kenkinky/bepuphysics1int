...
namespace BEPUphysics.BroadPhaseSystems.Hierarchies
{
    internal abstract class Node
    {
        ...
        internal abstract void GetOverlaps(ref Ray ray, FP maximumLength, IList<BroadPhaseEntry> outputOverlappedElements);
    ...
    internal sealed class InternalNode : Node
    {
        ...
        internal override void GetOverlaps(ref Ray ray, FP maximumLength, IList<BroadPhaseEntry> outputOverlappedElements)
        {
            FP result;
