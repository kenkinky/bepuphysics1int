    ...
    public class CharacterController : Updateable, IBeforeSolverUpdateable
    {
        ...
        public Vector3 Down
        {
            ...
            set
            {
                ...
                if (lengthSquared < Toolbox.Epsilon)
                    ...
                    Vector3.Divide(ref value, FP.Sqrt(lengthSquared), out value);
        ...
        public Vector3 ViewDirection
        {
            ...
            set
            {
                ...
                {
                    Vector3.Divide(ref value, FP.Sqrt(lengthSquared), out viewDirection);
                }
                else
                {
        ...
        void IBeforeSolverUpdateable.Update(FP dt)
        {
            ...
            try
            {
                ...
                FP verticalVelocity = Vector3.Dot(supportData.Normal, relativeVelocity);
                ...
                if (TryToJump)
                {
                    ...
                    if (SupportFinder.HasTraction)
                    {
                        ...
                        FP currentDownVelocity = Vector3.Dot(Down, relativeVelocity);
                    ...
                    else if (SupportFinder.HasSupport)
                    {
                        ...
                        FP currentNormalVelocity = Vector3.Dot(supportData.Normal, relativeVelocity);
                        //Target velocity is JumpSpeed.
                ...
                foreach (var contactData in pair.Contacts)
                {
                    ...
                    if (dot > minimumHeight)
                    {
                        ...
                        if (length > coreRadiusSquared)
                        {
                            ...
                            Vector3.Multiply(ref horizontalOffset, coreRadius / FP.Sqrt(length), out horizontalOffset);
                        }
                        ...
                        if (length > Toolbox.Epsilon)
                        {
                            ...
                            Vector3.Divide(ref offsetDirection, FP.Sqrt(length), out offsetDirection);
                        }
                        else
