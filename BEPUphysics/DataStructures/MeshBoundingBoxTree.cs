...
namespace BEPUphysics.DataStructures
{
    ...
    public class MeshBoundingBoxTree
    {
        ...
        /// <param name="outputOverlappedElements">Indices of triangles in the index buffer with bounding boxes which are overlapped by the query.</param>
        /// <returns>Whether or not any elements were overlapped.</returns>
        public bool GetOverlaps(Ray ray, FP maximumLength, IList<int> outputOverlappedElements)
        {
            if (root != null)
            {
                FP result;
        ...
        abstract class Node
        {
            ...
            internal abstract void GetOverlaps(ref Ray ray, FP maximumLength, IList<int> outputOverlappedElements);
        ...
        sealed class InternalNode : Node
        {
            ...
            internal override void GetOverlaps(ref Ray ray, FP maximumLength, IList<int> outputOverlappedElements)
            {
                FP result;
