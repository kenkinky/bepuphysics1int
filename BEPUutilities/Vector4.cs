...
namespace BEPUutilities
{
    ...
    public struct Vector4 : IEquatable<Vector4>
    {
        ...
        /// <param name="w">W component of the vector.</param>
        public Vector4(Vector3 xyz, FP w)
        {
            this.X = xyz.X;
            this.Y = xyz.Y;
            this.Z = xyz.Z;
        ...
        public Vector4(FP x, Vector3 yzw)
        {
            this.X = x;
            this.Y = yzw.X;
            this.Z = yzw.Y;
        ...
        /// <param name="z">Z component of the vector.</param>
        /// <param name="w">W component of the vector.</param>
        public Vector4(Vector2 xy, FP z, FP w)
        {
            this.X = xy.X;
            this.Y = xy.Y;
            this.Z = z;
        ...
        /// <param name="w">W component of the vector.</param>
        public Vector4(FP x, Vector2 yz, FP w)
        {
            this.X = x;
            this.Y = yz.X;
            this.Z = yz.Y;
        ...
        public Vector4(FP x, FP y, Vector2 zw)
        {
            this.X = x;
            this.Y = y;
            this.Z = zw.X;
        ...
        public static FP Dot(Vector4 a, Vector4 b)
        {
        ...
        public static void Dot(ref Vector4 a, ref Vector4 b, out FP product)
        {
        ...
        public static void Multiply(ref Vector4 v, FP scale, out Vector4 result)
        {
            result.X = v.X * scale;
            result.Y = v.Y * scale;
            result.Z = v.Z * scale;
        ...
        public static void Divide(ref Vector4 v, FP divisor, out Vector4 result)
        {
        ...
        public static Vector4 operator *(Vector4 v, FP f)
        {
            Vector4 toReturn;
            toReturn.X = v.X * f;
            toReturn.Y = v.Y * f;
        ...
        /// <param name="f">Amount to scale.</param>
        /// <returns>Scaled vector.</returns>
        public static Vector4 operator *(FP f, Vector4 v)
        {
            Vector4 toReturn;
            toReturn.X = v.X * f;
            toReturn.Y = v.Y * f;
        ...
        public static void DistanceSquared(ref Vector4 a, ref Vector4 b, out FP distanceSquared)
        {
            FP x = a.X - b.X;
            FP y = a.Y - b.Y;
            FP z = a.Z - b.Z;
        ...
        public static void Distance(ref Vector4 a, ref Vector4 b, out FP distance)
        {
            FP x = a.X - b.X;
            FP y = a.Y - b.Y;
            FP z = a.Z - b.Z;
        ...
        public static FP Distance(Vector4 a, Vector4 b)
        {
            FP toReturn;
        ...
        public static Vector4 Lerp(Vector4 start, Vector4 end, FP interpolationAmount)
        {
            Vector4 toReturn;
        ...
        public static void Lerp(ref Vector4 start, ref Vector4 end, FP interpolationAmount, out Vector4 result)
        {
        ...
        /// <param name="result">Interpolated intermediate state.</param>
        public static void Hermite(ref Vector4 value1, ref Vector4 tangent1, ref Vector4 value2, ref Vector4 tangent2, FP interpolationAmount, out Vector4 result)
        {
        ...
        /// <param name="interpolationAmount">Amount of the second point to use.</param>
        /// <returns>Interpolated intermediate state.</returns>
        public static Vector4 Hermite(Vector4 value1, Vector4 tangent1, Vector4 value2, Vector4 tangent2, FP interpolationAmount)
        {
            Vector4 toReturn;
