...
namespace BEPUphysics.CollisionShapes
{
    ...
    public struct CompoundShapeEntry
    {
        ...
        public CompoundShapeEntry(EntityShape shape, Vector3 position, FP weight)
        {
            position.Validate();
        ...
        ///<param name="weight">Weight of the entry.  This defines how much the entry contributes to its owner
        /// for the purposes of center of rotation computation.</param>
        public CompoundShapeEntry(EntityShape shape, Quaternion orientation, FP weight)
        {
    ...
    public class CompoundShape : EntityShape
    {
        ...
        public static void ComputeVolumeDistribution(IList<CompoundShapeEntry> entries, out FP volume, out Matrix3x3 volumeDistribution, out Vector3 center)
        {
            center = new Vector3();
        ...
        public static void TransformContribution(ref RigidTransform transform, ref Vector3 center, ref Matrix3x3 baseContribution, FP weight, out Matrix3x3 contribution)
        {
            Matrix3x3 rotation;
