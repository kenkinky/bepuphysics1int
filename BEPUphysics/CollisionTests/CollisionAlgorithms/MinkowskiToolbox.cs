...
namespace BEPUphysics.CollisionTests.CollisionAlgorithms
{
    ...
    public static class MinkowskiToolbox
    {
        ...
        public static void ExpandMinkowskiSum(FP marginA, FP marginB, ref Vector3 direction, out Vector3 contribution)
        {
            ...
            if (lengthSquared > Toolbox.Epsilon)
            {
                ...
                Vector3.Multiply(ref direction, (marginA + marginB) / FP.Sqrt(lengthSquared), out contribution);
        ...
        public static void ExpandMinkowskiSum(FP marginA, FP marginB, Vector3 direction, ref Vector3 toExpandA, ref Vector3 toExpandB)
        {
            FP lengthSquared = direction.LengthSquared();
            if (lengthSquared > Toolbox.Epsilon)
            {
